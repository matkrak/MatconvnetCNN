...
net.layers{end+1} = struct('type', 'conv', ...  %3
                           'weights', {{f*randn(9,9,20,40, 'single'),zeros(1,40,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
...
net.layers{end+1} = struct('type', 'conv', ...  %9
                           'weights', {{f*randn(5,5,80,100, 'single'), zeros(1,100,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...  %9
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...  %9
                           'weights', {{f*randn(1,1,200,20, 'single'), zeros(1,20,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...  %9
